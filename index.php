...
<body>
			...
			<div class="enquiry-form">
				<form method="post" action="thank-you.php" name="enquiry-form">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="txtReferal" name="txtReferal" aria-describedby="referalHelp" placeholder="*Where did you hear of us?" required>
					</div>
	...
	<footer>
		<div class="container">
			<p class="text-center">e: <a href="mailto:info@franchisefutures.co.uk">info@franchisefutures.co.uk</a><br>w: <a href="http://www.franchisefutures.co.uk">www.franchisefutures.co.uk</a></p>
		</div>
	</footer>
